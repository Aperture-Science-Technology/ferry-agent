...
export function SourcesFeedbackLoading({
...
export function SourcesFeedbackError({
  title,
  description,
  dismissLabel,
  onDismiss,
...
export function SourcesFeedbackPartial({
  title,
  description,
  ignoreLabel,
  onIgnore,
...
/**
 * Flexible shell for gateway hints and legacy call sites.
 * Prefer SourcesFeedbackLoading|Error|Partial for specimen states.
 */
