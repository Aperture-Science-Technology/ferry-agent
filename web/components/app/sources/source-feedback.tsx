...
/**
 * Pen Feedback / Gateway hint — ferry-surface, radius-md, pad 16, gap 12, border.
 * Same grammar as library/deliveries/devices/gateways lots.
 */
...
/**
 * Pen empty / unavailable — centered body copy inside the sources panel.
 */
