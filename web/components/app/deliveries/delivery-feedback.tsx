...
export function DeliveryFeedbackLoading({
...
export function DeliveryFeedbackError({
  title,
  description,
  dismissLabel,
  onDismiss,
...
export function DeliveryFeedbackPartial({
  title,
  description,
  ignoreLabel,
  onIgnore,
...
/**
 * Flexible shell for queue hints and legacy call sites.
 * Prefer DeliveryFeedbackLoading|Error|Partial for specimen states.
 */
