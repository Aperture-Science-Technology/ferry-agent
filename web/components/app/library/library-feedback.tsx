...
export function LibraryFeedbackLoading({
...
export function LibraryFeedbackError({
  title,
  description,
  dismissLabel,
  onDismiss,
...
export function LibraryFeedbackPartial({
  title,
  description,
  ignoreLabel,
  onIgnore,
...
/**
 * Flexible shell for hints and legacy call sites.
 * Prefer LibraryFeedbackLoading|Error|Partial for specimen states.
 */
