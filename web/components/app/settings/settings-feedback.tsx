...
export function SettingsFeedbackLoading({
...
export function SettingsFeedbackError({
  title,
  description,
  dismissLabel,
  onDismiss,
...
export function SettingsFeedbackPartial({
  title,
  description,
  ignoreLabel,
  onIgnore,
...
/**
 * Flexible shell for warnings and legacy call sites.
 * Prefer SettingsFeedbackLoading|Error|Partial for specimen states.
 */
