 ...
 * optional hint 12/500 muted.
 */
export const settingsFormControlClass =
  "h-auto min-h-10 w-full rounded-md border-border bg-ferry-surface-2 px-3 py-3 text-sm font-medium text-foreground shadow-none";
