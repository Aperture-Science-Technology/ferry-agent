...
export function GatewayFeedbackLoading({
...
export function GatewayFeedbackError({
  title,
  description,
  dismissLabel,
  onDismiss,
...
export function GatewayFeedbackPartial({
  title,
  description,
  ignoreLabel,
  onIgnore,
...
/**
 * Flexible shell for gateway strips and legacy call sites.
 * Prefer GatewayFeedbackLoading|Error|Partial for specimen states.
 */
...
/** Empty / unavailable — centered heading 18/500 + body 14/500. */
