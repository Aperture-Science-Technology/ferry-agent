...
export interface paths {
    "/api/v1/books": {
        ...
        /**
         * List Books
         * @description Liste les LibraryItem de l'utilisateur courant.
         */
    ...
    "/api/v1/devices/{device_id}": {
        ...
        /**
         * Update Device
         * @description Met a jour le nom/marque/modele d'un device ; recalcule delivery_tier
    ...
    "/api/v1/devices/{device_id}/link/callback": {
        ...
        /**
         * Link Callback
         * @description Echange le code OAuth contre un token et le stocke sur le device.
         */
